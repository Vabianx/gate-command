export const STORAGE_KEY="gate-command-save-v055";
const LEGACY_KEYS=["gate-command-save-v054","gate-command-save-v053","gate-command-save-v052","gate-command-save-v051","gate-command-save-v05","gate-command-save-v04"];
